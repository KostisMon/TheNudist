...
public class CharacterController2D : MonoBehaviour {
    ...
    public RuntimeAnimatorController nakedSparty;
    public RuntimeAnimatorController dressedSparty;
	...
	void Update()
	{
        ...
        }else if (_canDoubleJump && CrossPlatformInputManager.GetButtonDown("Jump")) // if can doublejump and jump pressed then doubled jump
        {
            DoJump();
    ...
    public void SpartyGetsNaked()
    {

        this.GetComponent<Animator>().runtimeAnimatorController = nakedSparty as RuntimeAnimatorController;


    }

    public void SpartyGetsDressed()
    {
        this.GetComponent<Animator>().runtimeAnimatorController = dressedSparty as RuntimeAnimatorController;
        Debug.Log("DONE");
